...
<nav>
    ...
    <div class="header">
<%--        <img src="${pageContext.request.contextPath}/res/images/newimg/logo.jpeg">--%>
        <div class="mallSearch">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="mallSearch-input">
                    <input class="header_search_input" type="text" name="product_name" placeholder="搜索 小马宝莉城 商品/品牌/店铺"
                           maxlength="50">
...
<%--    </c:forEach>--%>
        <c:forEach var="product" items="${requestScope.specialProductList}" varStatus="i">
            <img src="${pageContext.request.contextPath}/res/images/fore/WebsiteImage/banner/46.jpg"
                 name="${product.product_id}" id="banner${i.count}"
                 <c:if test="${i.count ==1 }">style="display: block;"</c:if> />
