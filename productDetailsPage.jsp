...
<head>
    ...
    <title>${requestScope.product.product_name}-小马宝莉城</title>
</head>
<body>
<nav>
...
<%--                src="${pageContext.request.contextPath}/res/images/newimg/马横幅.jpg"></a>--%>
        ...
        <div class="shopSearchHeader">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="shopSearchInput">
                    <input type="text" class="searchInput" name="product_name" placeholder="搜索 小马宝莉城 商品/品牌/店铺"
                           maxlength="50">
                    <input type="submit" value="搜小马" class="searchTmall">
                </div>
...
<%--                <img src="${pageContext.request.contextPath}/res/images/fore/WebsiteImage/context_ad.png">--%>
        ...
        <ul class="context_other_panel">
            ...
            <li class="tmall_points">送小马宝莉城积分<span><fmt:formatNumber type="number"
